...
<p style="text-align: center;">{{< imgsrcset command="Resize" title="liftweb.net original homepage design" original="/images/2010/11/original.png" alt="liftweb.net original homepage design" >}}</p>
## My redesign
...
<p style="text-align: center;">{{< imgsrcset command="Resize" title="my redesign of liftweb.net" original="/images/2010/11/01.png" alt="my redesign of liftweb.net" >}}</p>
...
{{< figured caption="Black on a coloured gradient is quite hard to read" >}}
  {{< imgsrcset command="Resize" class="wp-image-249" title="Black on a coloured gradient is quite hard to read" original="/images/2010/11/odd-contrast.png" alt="Black on a coloured gradient is quite hard to read" >}}
{{< /figured >}}
...
{{< figured caption="Checking my redesign colour contrast on the quotes section" >}}
  {{< imgsrcset command="Resize" title="Checking my redesign colour contrast on the quotes section" original="/images/2010/11/snook-colour-contrast.png" alt="Checking my redesign colour contrast on the quotes section" >}}
{{< /figured >}}
...
{{< imgsrcset command="Resize" class="wp-image-252" title="The original Lift main colours" original="/images/2010/11/original-scheme.png" alt="The original Lift main colours" >}}
...
{{< imgsrcset command="Resize" class="wp-image-253" title="My Lift redesign main colours" original="/images/2010/11/my-scheme.png" alt="My Lift redesign main colours" >}}
...
{{< figured caption="On the original design, you can see how the quote area stands out" >}}
  {{< imgsrcset command="Resize" class="wp-image-255" title="On the original design, you can see how the quote area stands out" original="/images/2010/11/light-on-dark.png" alt="On the original design, you can see how the quote area stands out" >}}
{{< /figured >}}
...
{{< imgsrcset command="Resize" class="wp-image-256" title="At this small size, you can see how my redesign draws the eye to the most important content" original="/images/2010/11/dark-on-ligt.png" alt="At this small size, you can see how my redesign draws the eye to the most important content" >}}<p class="wp-caption-text">At this small size, you can see how my redesign colours draw the eye to the most important content
</div>
...
{{< figured caption="the main page content on the original Lift page" >}}
  {{< imgsrcset command="Resize" class="wp-image-258" title="the main page content on the original Lift page" original="/images/2010/11/original-middle.png" alt="the main page content on the original Lift page" >}}
{{< /figured >}}
...
{{< figured caption="my redesigned main content area" >}}
  {{< imgsrcset command="Resize" class="wp-image-259" title="my redesigned main content area" original="/images/2010/11/middle.png" alt="my redesigned main content area" >}}
{{< /figured >}}
...
{{< figured caption="The grid I used for my redesign" >}}
  {{< imgsrcset command="Resize" class="wp-image-261" title="The grid I used for my redesign" original="/images/2010/11/gridded.png" alt="The grid I used for my redesign" >}}
{{< /figured >}}
...
{{< figured caption="my redesign on 10px grid" >}}
  {{< imgsrcset command="Resize" class="wp-image-262" title="my redesign on 10px grid" original="/images/2010/11/Screen-shot-2010-11-04-at-14.07.13.png" alt="my redesign on 10px grid" >}}
{{< /figured >}}
...
{{< figured caption="Book information with book images on my redesigned page" >}}
  {{< imgsrcset command="Resize" class="wp-image-267" title="Book information with book images on my redesigned page" original="/images/2010/11/Screen-shot-2010-11-04-at-15.41.35.png" alt="Book information with book images on my redesigned page" >}}
{{< /figured >}}
...
{{< figured caption="the icons I used to illustrate my redesign" >}}
  {{< imgsrcset command="Resize" class="wp-image-268" title="the icons I used to illustrate my redesign" original="/images/2010/11/icons.png" alt="the icons I used to illustrate my redesign" >}}
{{< /figured >}}
...
{{< figured caption="the background of my redesign without (above) and with (below) noise textured background" >}}
  {{< imgsrcset command="Resize" class="wp-image-272" title="the background of my redesign without (above) and with (below) noise textured background" original="/images/2010/11/noise2.png" alt="the background of my redesign without (above) and with (below) noise textured background" >}}
{{< /figured >}}
...
{{< figured caption="Random text-shadow on the Lift original design" >}}
  {{< imgsrcset command="Resize" class="wp-image-249" title="Random text-shadow on the Lift original design" original="/images/2010/11/odd-contrast.png" alt="Random text-shadow on the Lift original design" >}}
{{< /figured >}}
...
{{< figured caption="Light shadows visible around the boxes" >}}
  {{< imgsrcset command="Resize" class="wp-image-273" title="Light shadows visible around the boxes" original="/images/2010/11/shadows.png" alt="Light shadows visible around the boxes" >}}
{{< /figured >}}

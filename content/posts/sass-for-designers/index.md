...
{{< figure figcaption="an example of what your divider with a subtle border might look like" >}}
  	{{< img alt="a grey border line with a subtle grey box-shadow" src="divider.jpg" >}}
{{< /figure >}}

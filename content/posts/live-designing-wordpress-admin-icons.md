...
{{< figured caption="Using multiple artboards for WordPress admin icons in Sketch" >}}
  {{< imgsrcset alt="screenshot of the Sketch app showing WordPress admin icons on different artboards for different sizes" original="/images/2013/02/icons-in-sketch.png" >}}
{{< /figured >}}

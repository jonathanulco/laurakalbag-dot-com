...
{{< figure caption="Beautiful front cover illustration" >}}
  {{< imgsrcset src="web-2.jpg" alt="Beautiful front cover illustration" >}}
{{< /figure >}}
...
{{< figure caption="reading a sidenote from Hardboiled Web Design using iBooks on the iPhone 4" >}}
  {{< imgsrcset src="web.png" alt="reading a sidenote from Hardboiled Web Design using iBooks on the iPhone 4" >}}
{{< /figure >}}
...
<img src="web-1.jpg" alt="old-school postit bookmarks" >
...
{{< figure caption="Hardboiled Web Design by Andy Clarke" >}}
  {{< imgsrcset src="web-3.jpg" alt="Hardboiled Web Design by Andy Clarke" >}}
{{< /figure >}}

...
{{< figured caption="My notes from New Adventures in Web Design (click to view full size)" >}}
  {{< imgsrcset command="Resize" title="My notes from New Adventures in Web Design" original="/images/2011/01/new-adventures-in-web-design.gif" alt="My notes from New Adventures in Web Design" >}}
{{< /figured >}}

...
{{< figure caption="The Prince of Mist on iBooks" >}}
  {{< imgsrcset src="ibooks.jpg" alt="The Prince of Mist on iBooks" >}}
{{< /figure >}}
...
{{< figure caption="actions on Reeder for iPad" >}}
  {{< imgsrcset src="reeder.jpg" alt="actions on Reeder for iPad" >}}
{{< /figure >}}
...
{{< figure caption="the keyboard takes up a lot of space on the screen, but otherwise it’s very usable" >}}
  {{< imgsrcset src="wordpress.jpg" alt="WordPress on iPad" >}}
{{< /figure >}}
...
{{< figure caption="Twitterrific on iPad" >}}
  {{< imgsrcset src="twitter.jpg" alt="Twitterrific on iPad" >}}
{{< /figure >}}
...
{{< figure caption="Replying to a tweet on Twitterrific" >}}
  {{< imgsrcset class="wp-image-182" title="Replying to a tweet on Twitterrific" src="twitter-reply.jpg" alt="Replying to a tweet on Twitterrific" >}}
{{< /figure >}}
...
{{< figure caption="Profile details on Twitterrific" >}}
  {{< imgsrcset src="twitter-profile.jpg" alt="Profile details on Twitterrific" >}}
{{< /figure >}}
...
{{< figure caption="The incredibly simple Crop Suey interface ensures you see mostly the image itself" >}}
  {{< imgsrcset src="cropsuey.jpg" alt="Crop Suey on iPad" >}}
{{< /figure >}}
...
{{< figure caption="App stream by Appsfire is useful but not totally beautiful" >}}
  {{< imgsrcset src="appstream.jpg" alt="App stream by Appsfire" >}}
{{< /figure >}}

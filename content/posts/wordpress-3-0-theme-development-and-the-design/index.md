...
{{< figure caption="WordPress menus in action" >}}
  {{< imgsrcset src="Screen-shot-2010-07-16-at-20.42.35.png" alt="WordPress menus in action" >}}
{{< /figure >}}
...
{{< figure caption="Custom headers in WordPress 3.0" >}}
  {{< imgsrcset src="Screen-shot-2010-07-16-at-19.45.28.png" alt="Custom headers in WordPress 3.0" >}}
{{< /figure >}}
...
{{< figure caption="TwentyTen default theme preview" >}}
  {{< imgsrcset src="Screen-shot-2010-07-16-at-20.45.55.png" alt="TwentyTen default theme preview" >}}
{{< /figure >}}
...
{{< figure caption="WordPress 3.0 admin" >}}
  {{< imgsrcset src="Screen-shot-2010-07-16-at-20.48.11.png" alt="WordPress 3.0 admin" >}}
{{< /figure >}}
...
{{< figure caption="Um, what does that empty box do again? (title input in editor)" >}}
  {{< imgsrcset src="Screen-shot-2010-07-16-at-20.50.52.png" alt="The title input box in the WordPress editor with no label text" >}}
{{< /figure >}}
...
{{< figure caption="Grey alert bubble" >}}
  {{< imgsrcset src="Screen-shot-2010-07-16-at-20.52.41.png" alt="Grey alert bubble on the WordPress admin" >}}
{{< /figure >}}

...
{{< figured caption="Old homepage with big portfolio, loud colours, and the ill-fitting Ind.ie banner (now the Ind.ie logo is more subtly in the header)" >}}
  {{< imgsrcset command="Resize" class="wp-image-4636" original="/images/2015/04/old-homepage-812x1024.jpg" alt="Screenshot of the old laurakalbag.wpengine.com homepage" >}}
{{< /figured >}}

{{< figured caption="New homepage with blog posts, smaller portfolio and different colour mix" >}}
  {{< imgsrcset command="Resize" class="wp-image-4635" original="/images/2015/04/new-homepage-694x1024.jpg" alt="Screenshot of laurakalbag.wpengine.com homepage" >}}
{{< /figured >}}
...
{{< figured caption="The dropdown navigation menu which shows on narrower viewports is now more accessible. You can view the page source to see more." >}}
  {{< imgsrcset command="Resize" class="wp-image-4637" original="/images/2015/04/menu.jpg" alt="Screenshot of page navigation expanded under the Menu button" >}}
{{< /figured >}}
...
{{< figured caption="The colour picker in the WordPress post editor" >}}
  {{< imgsrcset command="Resize" class="wp-image-4634" original="/images/2015/04/Screen-Shot-2015-04-02-at-17.55.30-479x1024.png" alt="Screenshot of four colour picking areas" >}}
{{< /figured >}}

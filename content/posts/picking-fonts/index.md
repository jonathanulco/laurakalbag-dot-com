...
{{< imgsrcset src="Screen-shot-2010-07-05-at-18.39.37.png" alt="Firey font isn't really suitable for Daisy's Darling Cake shop" >}}
...
{{< imgsrcset src="Circus_Montreal_9_March_1812.jpg" alt="Old Victorian circus poster, lots and lots of fonts" >}}
...
{{< imgsrcset src="Screen-shot-2010-07-05-at-18.48.50.png" alt="Kaffeesatz as a header font with Droid Sans as the body font" >}}
...
{{< imgsrcset src="Screen-shot-2010-07-05-at-18.51.45.png" alt="Georgia as header and body font" >}}
...
{{< imgsrcset src="Screen-shot-2010-07-05-at-18.55.53.png" alt="The Museo Family" >}}
...
{{< imgsrcset src="Screen-shot-2010-07-05-at-18.59.14.png" alt="A paragraph in Papyrus" >}}
...
{{< figure caption="Typodermic’s Bouffant font in Mac’s Safari (top) and Windows’ Internet Explorer 6 (bottom)" >}}
  {{< imgsrcset src="Screen-shot-2010-07-05-at-19.14.52.jpg" alt="Typodermic's Bouffant font in Mac's Safari (top) and Windows' Internet Explorer 6 (bottom) " >}}
{{< /figure >}}

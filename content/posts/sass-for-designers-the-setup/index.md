...
{{< figure >}}
  {{< link href="http://incident57.com/codekit/" >}}
  	{{< img alt="screenshot of the Codekit website" src="codekit.png" >}}
  {{< /link >}}
{{< /figure >}}
...
{{< img alt="screenshot showing .scss file in the /sass folder" src="sass-folder.png" >}}

Next you open Codekit and add your project folder in the Files section.

{{< img alt="screenshot of adding a new project to the Files pane in Codekit" src="codekit-new1.png" >}}

After you’ve added your project folder, Codekit will automatically find the Sass file inside your project.

{{< img alt="screenshot of a project in Codekit" src="project-in-codekit.png" >}}
...
{{< img alt="screenshot of basic Sass being written into a .scss file" src="new-sass.png" >}}

If you go to the Log tab in Codekit, you can see that your Sass was successfully compiled into CSS.

{{< img alt="screenshot of the Log in Codekit showing a file successfully compiled" src="codekit-log1.png" >}}
...
{{< img alt="screenshot showing the /css folder created by Codekit" src="css-folder.png" >}}
...
{{< img alt="screenshot of invalid Sass using # instead of $" src="bad-sass.png" >}}
...
{{< img alt="screenshot of Codekit showing an error in the Sass" src="codekit-error.png" >}}

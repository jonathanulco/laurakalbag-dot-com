...
{{< figure caption="My Fitbit on my waistband" >}}
  	{{< imgsrcset src="fitbit-on-waistband.jpg" alt="My Fitbit on my waistband" >}}
{{< /figure >}}
...
{{< figure caption="Fitbit gives me encouraging messages and greetings too" >}}
  	{{< imgsrcset src="encouraging.jpg" alt="Fitbit gives me encouraging messages and greetings too" >}}
{{< /figure >}}
...
{{< figure caption="Fitbit wristband (left) and my homemade wristband (right)" >}}
  	{{< imgsrcset src="wristbands.jpg" alt="Fitbit wristband (left) and my homemade wristband (right)" >}}
{{< /figure >}}
...
{{< figure caption="The Fitbit dashboard" >}}
  	{{< imgsrcset src="fitbit-dashboard.jpg" alt="The Fitbit dashboard" >}}
{{< /figure >}}
...
{{< figure caption="one night’s sleep with the Fitbit" >}}
  	{{< imgsrcset src="sleep-log.jpg" alt="one night's sleep with the Fitbit" >}}
{{< /figure >}}

{{< figure caption="My sleep history" >}}
  	{{< imgsrcset src="sleep-stats.jpg" alt="My sleep history" >}}
{{< /figure >}}
...
{{< figure caption="Friends’ leaderboard" >}}
  	{{< imgsrcset src="leaderboard.jpg" alt="Friends' leaderboard" >}}
{{< /figure >}}
...
{{< figure caption="My Fitbit badges" >}}
  	{{< imgsrcset src="fitbit-badges.jpg" alt="My Fitbit badges" >}}
{{< /figure >}}

{{< imgsrcset src="fitbit-badge-notification.jpg" alt="A Fitbit badge notification email" >}}
...
{{< imgsrcset src="activity-log.jpg" alt="Fitbit activity log" >}}

{{< figure caption="a graph of my calories burnt so far today" >}}
  	{{< imgsrcset src="calories-burnt-graph.jpg" alt="a graph of my calories burnt so far today" >}}
{{< /figure >}}
...
{{< figure caption="Fitbit food log" >}}
  	{{< imgsrcset src="food-log.jpg" alt="Fitbit food log" >}}
{{< /figure >}}
...
{{< figure caption="Fitbit food goals" >}}
  	{{< imgsrcset src="food-goals.jpg" alt="Fitbit food goals" >}}
{{< /figure >}}
...
{{< figure caption="Fitbit Aria scales" >}}
  	{{< imgsrcset src="aria.jpg" alt="Fitbit Aria scales" >}}
{{< /figure >}}
...
{{< figure caption="My weight as recorded by the Aria scales" >}}
  	{{< imgsrcset src="weight.jpg" alt="My weight as recorded by the Aria scales" >}}
{{< /figure >}}

{{< figure caption="A lovely lean vs fat graph" >}}
  	{{< imgsrcset src="weight-graph.jpg" alt="A lovely lean vs fat graph" >}}
{{< /figure >}}
...
{{< figure caption="Mood history" >}}
  	{{< imgsrcset src="mood-log.jpg" alt="Mood history" >}}
{{< /figure >}}
...
{{< figure caption="my custom fruit and veg tracker" >}}
  	{{< imgsrcset src="fruit-and-veg.jpg" alt="my custom fruit and veg tracker" >}}
{{< /figure >}}
...
{{< figure caption="Weekly stats email" >}}
  	{{< imgsrcset src="weekly-stats.jpg" alt="Weekly stats email" >}}
{{< /figure >}}

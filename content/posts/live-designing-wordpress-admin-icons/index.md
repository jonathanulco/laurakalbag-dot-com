...
{{< figured caption="The final calendar icons (as designed quickly in 30 minutes or so)" >}}
  	{{< imgsrcset alt="small and large calendar icons" original="final-icons.png" >}}
{{< /figured >}}
...
{{< figured caption="Using multiple artboards for WordPress admin icons in Sketch" >}}
  {{< imgsrcset alt="screenshot of the Sketch app showing WordPress admin icons on different artboards for different sizes" original="icons-in-sketch.png" >}}
{{< /figured >}}

...
{{< imgsrcset original="Accessibility-By-Design.001.jpg" alt="Accessibility By Design. Laura Kalbag @laurakalbag. Ind.ie @indie" >}}
...
{{< imgsrcset original="Accessibility-By-Design.006.jpg" alt="Scale with easy and one end, and hard at the other" >}}
...
{{< imgsrcset original="Accessibility-By-Design.010.jpg" alt="Easy to hard scale with Angular in different locations depending on the developer" >}}
...
{{< imgsrcset original="Accessibility-By-Design.009.jpg" alt="Scale of difficulty with text content at easy and z-axis scrolling at hard" >}}
...
{{< imgsrcset original="Accessibility-By-Design.014.jpg" alt="Pulling accessibility up from the hard end of the scale to the easy end" >}}
...
{{< imgsrcset original="Accessibility-By-Design.035.jpg" alt="2012" >}}
...
{{< imgsrcset original="Accessibility-By-Design.037.jpg" alt="Screenshots of lots of grid frameworks" >}}
...
{{< imgsrcset original="Accessibility-By-Design.040.jpg" alt="2013" >}}
...
{{< imgsrcset original="Accessibility-By-Design.042.jpg" alt="Screenshots of websites that use parallax scrolling" >}}
...
{{< imgsrcset original="Accessibility-By-Design.044.jpg" alt="Screenshot examples of flat design" >}}

{{< imgsrcset original="Accessibility-By-Design.045.jpg" alt="2014" >}}
...
{{< imgsrcset original="Accessibility-By-Design.047.jpg" alt="Screenshots of web pages with video backgrounds" >}}
...
{{< imgsrcset original="Accessibility-By-Design.050.jpg" alt="Design depends largely on constraints - Charles Eames" >}}
...
{{< imgsrcset original="Accessibility-By-Design.071.jpg" alt="Different sized paragraphs at 10px, 12px, 18px and 24px" >}}
...
{{< imgsrcset original="Accessibility-By-Design.078.jpg" alt="Light and heavy paragraphs of text" >}}
...
{{< imgsrcset original="Accessibility-By-Design.080.jpg" alt="A paragraph set in the curly loopy GiddyUp Std" >}}
...
{{< imgsrcset original="Accessibility-By-Design.081.jpg" alt="Embrionic has very closed counters, Museo Sans has more open counters" >}}
...
{{< imgsrcset original="Accessibility-By-Design.108.jpg" alt="Extreme high contrast between bright green background and black text, and white text on a black background" >}}
...
{{< imgsrcset original="Accessibility-By-Design.132.jpg" alt="Laura Kalbag. laurakalbag.wpengine.com. @laurakalbag. ind.ie. @indie" >}}

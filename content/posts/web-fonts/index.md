...
{{< figured caption="Quicksand font at Font Squirrel" >}}
  {{< imgsrcset original="Screen-shot-2010-07-02-at-21.31.14.png" alt="Quicksand font at Font Squirrel" >}}
{{< /figured >}}
...
{{< figured caption="Font Squirrel @font-face kit download" >}}
  {{< imgsrcset original="Screen-shot-2010-07-02-at-21.32.52.png" alt="Font Squirrel @font-face kit download" >}}
{{< /figured >}}

{{< figured caption="All the files in the Font Squirrel @font-face kit" >}}
  {{< imgsrcset original="Screen-shot-2010-07-02-at-21.37.41.png" alt="All the files in the Font Squirrel @font-face kit" >}}
{{< /figured >}}
...
{{< figured caption="One of FontShop’s lovely e-mail newsletters" >}}
  {{< imgsrcset original="Screen-shot-2010-07-02-at-21.43.02.png" alt="One of FontShop's lovely e-mail newsletters" >}}
{{< /figured >}}
...
{{< figured caption="Proper nice fonts from Typekit" >}}
  {{< imgsrcset original="Screen-shot-2010-07-02-at-21.46.36.png" alt="Proper nice fonts from Typekit" >}}
{{< /figured >}}
...
{{< figured caption="Typekit preview of Atrament Web on Windows XP Internet Explorer 6" >}}
  {{< imgsrcset original="Screen-shot-2010-07-02-at-21.50.10.png" alt="Typekit preview of Atrament Web on Windows XP Internet Explorer 6" >}}
{{< /figured >}}
...
{{< figured caption="Google Font Directory" >}}
  {{< imgsrcset original="Screen-shot-2010-07-02-at-21.55.27.png" alt="Google Font Directory" >}}
{{< /figured >}}
...
{{< figured caption="Fonts.com Web Fonts using about a million fonts" >}}
  {{< imgsrcset original="Screen-shot-2010-07-02-at-21.57.05.png" alt="Fonts.com Web Fonts using about a million fonts" >}}
{{< /figured >}}
